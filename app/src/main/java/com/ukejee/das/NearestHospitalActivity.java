...
import com.ukejee.das.databinding.ActivityNearestHospitalBinding;
...
public class NearestHospitalActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private ActivityNearestHospitalBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNearestHospitalBinding.inflate(getLayoutInflater());
    ...
    private void setUpUi(final Activity activity){
        ...
        binding.findHospitalBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void getNearestHospitals(final Location userLocation){
